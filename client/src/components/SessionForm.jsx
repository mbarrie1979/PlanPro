...
const SessionForm = () => {
  ...
  return (
    <>
      ...
      <div className="session-form home">
        <Form noValidate validated={validated} onSubmit={handleFormSubmit}>
          ...
          <h1 className="home formTitle rock-salt-regular text-black">
            {" "}
            Add Session Form
          </h1>
          ...
          <Button
            className="sessionSubmit"
            disabled={
              !(
                sessionFormData.name &&
                sessionFormData.description &&
                sessionFormData.date &&
                sessionFormData.room &&
