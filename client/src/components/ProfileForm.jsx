    ...
    <>
      ...
      <div className="profile-form">
        <Form noValidate validated={validated} onSubmit={handleFormSubmit}>
          ...
          <h2 className="formTitle rock-salt-regular text-black">
            {" "}
            User Profile Form
          </h2>
          ...
          <Form.Group className="mb-3 profileForm">
            <Form.Label htmlFor="getEmailReminders">
              Get Email Reminders of Upcoming Sessions
            </Form.Label>
            <Form.Check
              type="checkbox"
          ...
          <Form.Group className="mb-3 profileForm">
            <Form.Label htmlFor="getSMSReminders">
              get SMS Reminders of Upcoming Sessions
            </Form.Label>
            <Form.Check
              type="checkbox"
          ...
          <Button className="profileSubmit" type="submit" variant="success">
            Submit
          </Button>
        </Form>
      </div>
