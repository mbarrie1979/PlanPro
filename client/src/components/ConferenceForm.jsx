...
const ConferenceForm = () => {
  ...
  return (
    <>
      ...
      <div className="conferenceForm home">
        <Form noValidate validated={validated} onSubmit={handleFormSubmit}>
          ...
          <h2 className="form-title rock-salt-regular text-black">
            {" "}
            Add Conference Form
          </h2>
          ...
          <Button
            ...
            disabled={
              !(
                ...
                conferenceFormData.description &&
                conferenceFormData.startDate &&
                conferenceFormData.endDate &&
                conferenceFormData.location &&
                conferenceFormData.image
              )
            }
            type="submit"
            variant="success"
